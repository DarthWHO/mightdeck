...
class PlayArea():
    ...
    def update_styles(self):
        ...
        style.configure(f'Spin{self.colour}.TSpinbox', bordercolor=self.bordercolor, arrowsize=24)  
...
# btn_chance = Button(info_frame_buttons, text="Chances")
# btn_chance.grid(row=1, column=0,sticky=E, padx=2)
